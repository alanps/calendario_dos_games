...
<table width="600" align="center" cellpadding="0" cellspacing="0" border="0" style="font-family: 'Arial', Arial;color:#000; text-align:center; background-color: #FFF !important;">
        ...
        <tr>
            <td>
            <br><br><br>
                <div style="font-size: 14px; font-weight: bold; ">BEM VINDO AO</div>
        ...
        <tr>
            <td style="padding-bottom:50px">
                ...
                <br><br>
                <div style="font-size: 13px; font-weight: bold;">OLÁ {{ $nome }}</div>
                <br>
                <center><div style="color: #757575; font-size: 12px; width: 380px; line-height: 19px;">Lorem ipsum dolor sit amet, habeo persequeris cum ea, natum epicuri deseruisse vix ne. Id pri facilisis salutatus, quis falli percipit mei ne. Ea has aperiam albucius, docendi fabellas his id. Ne prima platonem vim, ex graeci eligendi duo. Tritani dolorem qui.</div></center>
                <br>
                <div style="font-size: 12px; font-weight: bold; ">BEM VINDO!</div>
                <br>
